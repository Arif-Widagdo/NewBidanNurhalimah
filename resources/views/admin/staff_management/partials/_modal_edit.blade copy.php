...
<div class="modal fade" id="modal-edit-staff{{ $staff_edit->employe_id }}">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form action="{{ route('staffs.update', $staff->id) }}" method="POST" id="form_edit_staff{{ $loop->iteration }}">
            @csrf
            @method('PATCH')
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" class="form-control error_input_name" id="username" placeholder="{{ __('Enter') }} {{ __('Username') }}" value="{{ $staff_edit->user_id != '' ? $staff_edit->account->username : '' }}" name="username">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="email" class="form-control error_input_name" id="email" placeholder="{{ __('Enter') }} {{ __('Email') }}" value="{{ $staff_edit->user_id != '' ? $staff_edit->account->email : '' }}" name="email">
                                                    <span class="text-danger error-text email_error"></span>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="status" class="col-lg-3 col-form-label">
                                            ...
                                            <div class="form-group row">
                                                <label for="position_id" class="col-lg-3 col-form-label">
                                            ...
                                            <div class="form-group row">
                                                <label for="inputName" class="col-lg-3 col-form-label ">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group row">
                                                <label for="inputPlaceBrithday" class="col-lg-3 col-form-label ">
                                            ...
                                            <div class="form-group row align-items-center">
                                                <label for="inputDateBrithday" class="col-lg-3 col-form-label">
                                                    {{ __('Date of Birthday') }}<span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-9">
                                                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                                        <input type="text" class="form-control datetimepicker-input error_input_date_brithday" placeholder="{{ __('Enter your Date of Birth') }}" data-target="#reservationdate" value="{{ $staff_edit->date_brithday != '' ? date('d-m-Y', strtotime($staff_edit->date_brithday)) : '' }}" name="date_brithday">
                                            ...
                                            <div class="form-group row">
                                                <label for="phoneNumber" class="col-lg-3 col-form-label">
