...
return [
    ...
    */
    ...
    "without_spaces" => "The :attribute does not contain spaces.",
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'custom' => [
        'oldpassword' => [
            ...
            'min' => 'Current password must have atleast 8 characters',
        ...
        'username' => [
            ...
            'accepted' => 'Username does not contain spaces',
        ...
        'work_status' => [
            'required' => 'Job Status must be selected!',
        ],
        'gender' => [
        ...
        'place_brithdayHusband' => [
            'required' => 'Place of Birth of Husband must be filled in!',
        ],
        'date_brithdayHusband' => [
            'required' => 'Husband date of birth must be filled in!',
        ],
        'phoneNumberHusband' => [
            'required' => 'Husband telephone number is required!',
        ],
        'job_idHusband' => [
            'required' => 'Husband Job must be selected!',
        ],
        'graduated_idHusband' => [
            'required' => 'Husband Graduates must be selected!',
        ],
        'addressHusband' => [
            'required' => 'Husband address is required!',
        ],
